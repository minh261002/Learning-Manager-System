            ...
            <div class="breadcrumb-content">
                <div class="media media-card align-items-center pb-4">
                    <div class="media-img media--img media-img-md rounded-full">
                        <img class="rounded-full" src="{{ $instructor->photo ?? asset('uploads/no_image.jpg') }}"
                    ...
                    <div class="media-body">
                        ...
                        <span class="d-block lh-18 pt-1 pb-2">
                            Tham gia từ {{ date('d/m/Y', strtotime($instructor->created_at)) }}
                        </span>
                    </div>
                </div><!-- end media -->
    ...
    <section class="course-area section-padding">
        <div class="container">
            <div class="d-flex align-items-center justify-content-between pb-3">
                <h3 class="fs-24 font-weight-semi-bold">Khoá Học</h3>
            </div>
            ...
            <div class="row pt-30px">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    @auth
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="icon-element icon-element-sm shadow-sm cursor-pointer"
                                                id="{{ $course->id }}" title="Yêu Thích" onclick="addToWishLish(this.id)">
                ...
                @empty
                    <div class="alert alert-warning">Không có khoá học nào</div>
                @endforelse
            </div>
        </div><!-- end container -->
    </section>
