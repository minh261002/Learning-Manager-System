                ...
                <div class="col-lg-6 mb-4 mx-auto">
                    ...
                    <form method="post" class="pt-4" method="POST">
                        ...
                        <div class="btn-box">
                            <div class="d-flex align-items-center justify-content-between pb-4">
                                <div class="custom-control custom-checkbox fs-15">
                                    <input type="checkbox" class="custom-control-input" id="rememberMeCheckbox"
                                        name="remember">
                                    <label class="custom-control-label custom--control-label" for="rememberMeCheckbox">Lưu
                                        Thông Tin</label>
                            ...
                            <p class="fs-14 pt-2">Bạn Chưa Có Tài Khoản? <a href="{{ route('register') }}"
                                    class="text-color hover-underline">Đăng Ký Ngay</a></p>
                        </div><!-- end btn-box -->


                        <p class="text-center fs-18 my-3">Hoặc</p>

                        <div class="d-flex flex-column pb-4">
                            <a href="" class="btn theme-btn flex-grow-1 mx-2 mb-2"><i
                                    class="la la-google mr-2"></i>Đăng Nhập Với Google</a>
                            <a href="" class="btn theme-btn flex-grow-1 mx-2 mb-2"><i
                                    class="la la-facebook mr-2"></i>Đăng Nhập Với Facebook</a>
                        </div>
