                ...
                <div class="col-lg-6 mb-4 mx-auto">
                    ...
                    <form method="post" action="{{ route('register.post') }}" class="pt-4">
                        ...
                        <div class="btn-box">
                            ...
                            <button class="btn theme-btn" type="submit">Đăng Ký <i
                                    class="la la-arrow-right icon ml-1"></i></button>
                            <p class="fs-14 pt-2">Bạn Đã Có Tài Khoản? <a href="{{ route('login') }}"
                                    class="text-color hover-underline">Đăng Nhập Ngay</a></p>
                        </div><!-- end btn-box -->
